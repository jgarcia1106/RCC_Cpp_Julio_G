...
int main(int argc, char** argv) {
    ...
    unsigned short rctngl, totCov;
    rctngl=fncHt*fncLnth;
    totCov=2*2*rctngl;//Double coat both sides of rectangle
    nCans=totCov/pntCov+1;//+1 for ceiling function round up
