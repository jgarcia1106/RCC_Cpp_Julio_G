...
int main(int argc, char** argv) {
    ...
    unsigned char fncHt,fncLnth,nCans;
    ...
    cout<<"Fence Height = "<<static_cast<int>(fncHt)<<" feet"<<endl;
    cout<<"Fence Lenght = "<<static_cast<int>(fncLnth)<<" feet"<<endl;
    cout<<"Number of Cans of Paint = "<<static_cast<int>(nCans)<<" cans"<<endl;
